...
<head>
    <title>İlknur Karaçelik Ders1 Okul Kayıt</title>
    <!-- Meta tag Keywords -->
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox2" runat="server"  placeholder="mail@email.com" CssClass="form-control"></asp:TextBox>

                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Şehriniz</label>
                        <asp:TextBox ID="TextBox3" runat="server"  placeholder="Şehir..." CssClass="form-control"></asp:TextBox>
